<x-app-layout>
 ...
 <a href="{{ route('admin.buku.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-4 py-2 rounded-md mb-4 inline-block shadow">+ Tambah Buku</a>
 @if(session('success'))
