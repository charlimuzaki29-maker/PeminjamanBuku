<x-app-layout>
 ...
 <a href="{{ route('admin.peminjaman.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-4 py-2 rounded-md mb-4 inline-block shadow">+ Catat Peminjaman Baru</a>
 @if(session('success'))
 ...
 @csrf
 @method('PATCH')
 <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium px-3 py-1 rounded text-sm shadow mb-1">Kembalikan</button>
 </form>
 @endif
